    ...
    <section class="container main my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-12 col-12">
          <img class="img-fluid w-100 pb-1" src="img/laptop8.png" alt="">
          ...
          <div class="small-img">
            ...
            <div class="small-img-col">
              <a href="laptop5.php"><img src = "img/laptop5.png" width="100%" class = "small-img" alt=""></a>
            </div>
            <div class="small-img-col">
              <a href="laptop2.php"><img src = "img/laptop2.png" width="100%" class = "small-img" alt=""></a>
            </div>
          </div>
        </div>

    <div class="col-lg-6 col-md-12 col-12">
      <h3 class="text-light">KriziaWare Ford Thin 9SEXR-838</h3>
      <div class = "rating">
