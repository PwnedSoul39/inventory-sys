...
<html lang="en">
    ...
    <body>
       ...
       <main> <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;"> <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3"> <div class="col"> <div class="card h-100 shadow-sm"> <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcS667FXILBuLPv_WYB399z_eOJeIB_9K3oSV_tILBuXoSb8oRIZfgdbkxuiXx_aMqE-okLUb6RMXTZBkXKmcGMNNNaevKNKdxsEcm3JUarHOpxWR0TufBOxWYERJy6MwL6lxx0&usqp=CAc" class="card-img-top" alt="..."> <div class="card-body"> <div class="clearfix mb-3"> <span class="float-end price-hp">5.76&dollar;</span> </div> <h5 class="card-title">Gaming Keyboard And Mouse Combo Bundle Rainbow LED Game Equipment USB Wired PC Laptop T-WOLF TF200.</h5> <div class="text-center my-4"> <a href="#" class="btn btn-warning">Check offer</a> </div> </div> </div> </div> <div class="col"> <div class="card h-100 shadow-sm"> <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcSMWExvHH18SERrEHQtgVRt546O8R6qTLLWyd-C6HyxfQ2Ekw5mVBVe94hOMIs3H2xNuMi3U3AsaauYViPdhOjBgowVIOTaAWvDKQUAAFNfWngRnKmunScqn6z4OyKKwrhHSFA&usqp=CAc" 
