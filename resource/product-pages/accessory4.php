	...
	<body data-bs-theme="dark">
		...
		<section class="py-5" id="item-sec">
			<div class="container-fluid text-light">
				<div class="row">
					<div class="col-md-6">
						<img class="img-fluid" src="../img/prod2.jpg" alt="">
					...
					<div class="col-md-6">
						<h1 class="display-3 py-2">KriziaWare Gaming Mouse</h1>
						...
						<h3 class="display-4">$485.95</h3>
						<p class="fs-4">
							Conquer your gaming sessions with ergonomic dominance, courtesy of our gaming mouse. Its sleek design contours to your hand, providing hours of comfort without sacrificing performance. Say goodbye to fatigue and hello to extended gaming sessions filled with unwavering precision.
						</p>
