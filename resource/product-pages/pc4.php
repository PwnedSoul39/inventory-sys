	...
	<body data-bs-theme="dark">
		...
		<section id="section1">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6">
						<img class="img" src="../img/product-pages/system-unit2.jpg" alt="">
					...
					<div class="col-md-6">
						<h1 class="text-light pt-2">KriziaWare Nova V2</h1>
						...
						<div class="text-light">
							...
							<h5>Storage: 1TB NVMe SSD + 2TB HDD</h5>
