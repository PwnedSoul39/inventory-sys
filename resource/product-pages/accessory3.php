	...
	<body data-bs-theme="dark">
		...
		<section class="py-5" id="item-sec">
			<div class="container-fluid text-light">
				<div class="row">
					<div class="col-md-6">
						<img class="img-fluid" src="../img/product-pages/acc-3.jpg" alt="">
					...
					<div class="col-md-6">
						<h1 class="display-3 py-2">KriziaWare Atmos X-23r</h1>
						...
						<h3 class="display-4">$2499.95</h3>
						<p class="fs-4">
							Prepare to be swept away by epic soundscapes that breathe life into virtual worlds. Our gaming speakers unlock the full potential of game soundtracks, enveloping you in sweeping orchestral melodies or heart-pounding electronic beats. Brace yourself for a cinematic journey where the boundaries between reality and virtuality blur.
						</p>
