	...
	<body data-bs-theme="dark">
		...
		<section id="section1">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6">
						<img class="img" src="../img/product-pages/monitor.png" alt="">

						<div class="row prod-img">
							<h4 class="text-light pb-3">Related Products</h4>
							<div class="col">
								<a href="./pc7.php"><img class="img-rel" src="../img/product-pages/monitor1.jpg" alt=""></a>
							</div>
							<div class="col">
								<a href="./pc5.php"><img class="img-rel" src="../img/product-pages/monitor2.jpg" alt=""></a>
							</div>
							<div class="col">
					...
					<div class="col-md-6">
						<h1 class="text-light pt-2">AuroraTech Gaming Monitor</h1>
						<p class="text-light specs">27 inches | 2560 x 1440 pixels (QHD) | 144Hz or 240Hz</p>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<h3 class="text-light">$1,100</h3>

						<div class="text-light">
							<h4 class="text-light pt-2">SPECIFICATIONS</h4>
							<h5>Display Size: 27 inches</h5>
							<h5>Resolution: 2560 x 1440 pixels (QHD) or 3840 x 2160 pixels (4K UHD)</h5>
							<h5>Response Time: 1ms</h5>
							<h5>Refresh Rate: 144Hz or 240Hz</h5>
