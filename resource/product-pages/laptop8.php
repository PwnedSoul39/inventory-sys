		...
		<section class="container-fluid py-5 mb-4">
			<div class="row d-flex justify-content-center mt-5 py-2">
				<div class="col-lg-5 col-md-12 col-12">
					<img src="../img/product-pages/laptop8.png" alt="" class="rounded img-fluid w-100 pb-1">
				...
				<div class="col-lg-6 col-md-12 col-12">
					<h3 class="text-body-emphasis">KriziaWare Ford Thin 9SEXR-838</h3>
					<div class="rating">
					...
					<div class="text-body-emphasis my-5">
						...
						<p class="text-justify lead fs-5">
							The KriziaWare Ford Thin 9SEXR-838 is a gaming and entertainment-centric machine that offers an immersive experience. Its high-refresh-rate display and dedicated NVIDIA GeForce GTX graphics card deliver stunning visuals, while the powerful Intel Core i7 processor ensures smooth gameplay and multitasking. The laptop's customizable RGB keyboard and enhanced audio system provide an engaging atmosphere for gaming and media consumption.
						</p>
					</div>
					<div class="specs text-body-emphasis">
						...
						<ul class="list-unstyled fs-5">
							...
							<li><span class="fw-bolder">GPU:</span>&nbsp;NVIDIA GeForce RTX 3080</li>
							<li><span class="fw-bolder">RAM:</span>&nbsp;16GB DDR4</li>
							<li><span class="fw-bolder">Storage:</span>&nbsp;1TB PCIe NVMe SSD</li>
							<li><span class="fw-bolder">Display:</span>&nbsp;17.3-inch Full HD IPS panel with 300Hz refresh rate</li>
						</ul>
					</div>
				</div>
			</div>
