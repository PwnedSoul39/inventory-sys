		...
		<section class="container-fluid py-5 mb-4">
			<div class="row d-flex justify-content-center mt-5 py-2">
				...
				<div class="col-lg-6 col-md-12 col-12">
					<h3 class="text-body-emphasis">KriziaWare Velociraptor R5</h3>
					<div class="rating">
					...
					<div class="specs text-body-emphasis">
						...
						<ul class="list-unstyled fs-5">
							...
							<li><span class="fw-bolder">Display:</span>&nbsp;17.3-inch FHD(1920 x 1080) 360Hz</li>
						</ul>
					</div>
				</div>
			</div>
