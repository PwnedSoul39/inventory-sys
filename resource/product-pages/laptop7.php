			...
			<div class="row d-flex justify-content-center mt-5 py-2">
				<div class="col-lg-5 col-md-12 col-12">
					...
					<div class="row d-flex justify-content-between">
						<div class="col">
							<a href="laptop8.php">
								<img class="img-rel rounded" src="../img/product-pages/laptop8.png" alt="">
							</a>
						</div>
						<div class="col">
							<a href="laptop1.php">
				...
				<div class="col-lg-6 col-md-12 col-12">
					<h3 class="text-body-emphasis">KriziaWare Razer Sword 4 QHD+</h3>
					<div class="rating">
					...
					<div class="number">
						<span class="fw-bold text-body-emphasis">$3,599.99</span>
					</div>
