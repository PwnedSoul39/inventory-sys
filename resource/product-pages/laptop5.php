		...
		<section class="container-fluid py-5 mb-4">
			<div class="row d-flex justify-content-center mt-5 py-2">
				<div class="col-lg-5 col-md-12 col-12">
					<img src="../img/product-pages/laptop5.png" alt="" class="rounded img-fluid w-100 pb-1">
				...
				<div class="col-lg-6 col-md-12 col-12">
					<h3 class="text-light">KriziaWare NP6271J (CLEVO NP70RNJS) Gaming Laptop</h3>
					<div class="number">
						<span class="fw-bold text-light">$1,119</span>
					</div>
					...
					<div class="text-light my-5">
						...
						<p class="text-justify lead fs-5">
							The KriziaWare NP6271J (CLEVO NP70RNJS) GAMING LAPTOP combines power and elegance in a compact form factor. Its ultra-thin design and edge-to-edge display provide a premium look and feel. With an Intel Core i5 processor and solid-state drive, it offers quick boot times and responsive performance. The laptop's fingerprint sensor ensures enhanced security, and the long battery life keeps you productive throughout the day.
						</p>
					</div>
					<div class="specs text-light">
						<h3 class="fw-bolder">Specifications</h3>
						<ul class="list-unstyled fs-5">
							<li><span class="fw-bolder">Processor:</span>&nbsp;Intel Core i5-11800H</li>
							<li><span class="fw-bolder">GPU:</span>&nbsp;NVIDIA GeForce RTX 3060</li>
							<li><span class="fw-bolder">RAM:</span>&nbsp;16GB DDR4</li>
							<li><span class="fw-bolder">Storage:</span>&nbsp;512GB NVMe SSD</li>
