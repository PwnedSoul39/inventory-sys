	...
	<body data-bs-theme="dark">
		...
		<section id="section1">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6">
						<img class="img" src="../img/product-pages/system-unit1.png" alt="">

						<div class="row prod-img">
							<h4 class="text-light pb-3">Related Products</h4>
							<div class="col">
								<a href="./pc8.php"><img class="img-rel" src="../img/product-pages/system-unit3.png" alt=""></a>
							</div>
							<div class="col">
					...
					<div class="col-md-6">
						<h1 class="text-light pt-2">KriziaWare V5 J16</h1>
						<p class="text-light specs">AMD Ryzen 3 Zen 2 | RTX 3080 | 16GB </p>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<h3 class="text-light">$990</h3>

						<div class="text-light">
							<h4 class="text-light pt-2">SPECIFICATIONS</h4>
							<h5>Processor: AMD Ryzen 3 Zen 2</h5>
