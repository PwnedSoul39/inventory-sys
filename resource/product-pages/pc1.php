	...
	<body data-bs-theme="dark">
		...
		<section id="section1">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6">
						<img class="img" src="../img/product-pages/desktop1.jpg" alt="">

						<div class="row prod-img">
							<h4 class="text-light pb-3">Related Products</h4>
							<div class="col">
								<a href="./pc2.php"><img class="img-rel" src="../img/product-pages/system-unit.jpg" alt=""></a>
							</div>
							<div class="col">
								<a href="./pc3.php"><img class="img-rel" src="../img/product-pages/monitor.png" alt=""></a>
							</div>
							<div class="col">
					...
					<div class="col-md-6">
						<h1 class="text-light pt-2">KriziaWare QuantumForce Phoenix</h1>
						<p class="text-light specs">CORE I9 | RX 6900 XT | 16GB to 32GB</p>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<span><i class='bx bxs-star'></i></span>
						<h3 class="text-light">$2,999</h3>

						<div class="text-light">
							<h4 class="text-light pt-2">SPECIFICATIONS</h4>
							<h5>Processor: Intel Core i9-10900K</h5>
							<h5>Graphics Card: AMD Radeon RX 6900 XT</h5>
							<h5>RAM: 16GB to 32GB</h5>
							<h5>Storage: 1TB NVMe SSD</h5>
							<h5>Motherboard: Z590 or X570 chipset</h5>
						</div>
