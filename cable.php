            ...
            <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;">
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">K880 104Key Mechanical Hot swappable Keyboard wired RGB Gaming Office PC computer keycaps for mecha.</h5>
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">USB wired keyboard office style for PC laptop DK500.</h5>
                        <div class="text-center my-4">
                        <a href="#" class="btn btn-warning">Check offer</a>
                        </div>
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">✅100% AMZ Keyboard set 104 keys Rainbow Gaming USB Wired Keyboard colorful button Mouse Suit LED.</h5>
                        <div class="text-center my-4">
                        <a href="#" class="btn btn-warning">Check offer</a>
                        </div>
                        <div class="clearfix mb-1">
