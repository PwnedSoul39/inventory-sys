        ...
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="text-wrapper">
              <h5 class="card-title">Gaming Keyboard And Mouse Combo Bundle Rainbow LED Game Equipment
                USB
                Wired PC Laptop T-WOLF TF200.</h5>
              </div>
        ...
        <div class="col">
          <div class="card h-100 shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="text-wrapper">
                <h5 class="card-title">HP Laptop Charger Adapter Elitebook 210 G1 250 G3 250 G4 250 G5
                  255
                  G4 255 G5 255 G6 355 G2 455 G3</h5>
                </div>
                <div class="text-center my-4">
                  <a href="#" class="btn btn-secondary">Check offer</a>
                </div>
