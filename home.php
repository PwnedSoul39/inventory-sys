	...
	<body class="bg-body" style="overflow-x: hidden;">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navStuff">
						<ul class="navList navbar-nav ms-auto">
							...
							<li class="nav-item">
								<a class="nav-link link-body-emphasis" href="#product">Featured Products</a>
							</li>
							<li class="nav-item">
		...
		<main>
					...
					<div class="row row-cols-1 row-cols-md-4 g-3">
						<div class="col-sm-4 col-md-4">
							<div class="prod_card card h-100 bg-transparent" data-aos="fade-right" data-aos-duration="2000">
								<img class="card-img-top img-fluid" src="./resource/img/fprod1.jpg" alt="FPROD1">
								<div class="card-body">
									<div class="text-center">
										<a class="seymour btn btn-info w-50 p-1" href="product.php" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="3000">See More</a>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-4 col-md-4">
							<div class="prod_card card h-100 bg-transparent" data-aos="zoom-in" data-aos-duration="2000">
								<img class="card-img-top img-fluid" src="./resource/img/fprod2.jpg" alt="FPROD2">
								<div class="card-body">
									<div class="text-center">
										<a class="seymour btn btn-info w-50 p-1" href="product.php" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="3000">See More</a>
									</div>
						...
						<div class="col-sm-4 col-md-4">
							<div class="prod_card card h-100 bg-transparent" data-aos="fade-left" data-aos-duration="2000">
								<img class="card-img-top img-fluid" src="./resource/img/fprod3.jpg" alt="FPROD3">
								<div class="card-body">
									<div class="text-center">
										<a class="seymour btn btn-info w-50 p-1" href="product.php" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="3000">See More</a>
									</div>
			...
			<section class="container-fluid d-flex align-items-center mt-4" id="about">
				<div class="row">
					<div class="col">
						<h1 class="home-title text-center text-body-emphasis" data-aos="fade-down" data-aos-duration="2000">About Us</h1>
						<div class="my-3 lead text-body-emphasis">
					...
					<div class="row mt-5">
						<div class="col" data-aos="fade-up" data-aos-duration="2000">
							<h3 class="address text-center text-body-emphasis">Lot 19 Block 1, St. Paul Village, Sumapang Matanda, Malolos, Bulacan</h3>
						</div>
					</div>
					<div class="row mt-4">
						<div class="col">
							<ul class="list-inline text-center text-body-emphasis">
								<li class="list-inline-item" data-aos="fade-right" data-aos-duration="2000">
									<a class="nav-link link-body-emphasis mx-2" href="https://facebook.com" target="_blank">
								...
								<li class="list-inline-item" data-aos="fade-down" data-aos-duration="2000">
									<a class="nav-link link-body-emphasis mx-2" href="https://instagram.com" target="_blank">
								...
								<li class="list-inline-item" data-aos="fade-left" data-aos-duration="2000">
									<a class="nav-link link-body-emphasis mx-2" href="https://twitter.com" target="_blank">
