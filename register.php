			...
			<div class="container py-5 h-100">
				<div class="row d-flex justify-content-center align-items-center h-100">
					<div class="col-12 col-md-8 col-lg-6 col-xl-5">
						<div class="register card text-body-emphasis bg-body-tertiary">
									...
									<div class="row g-3 my-3">
										<div class="col-12">
											<div class="form-floating">
												<input class="reg-box form-control" type="text" placeholder="Username" name="user_reg" id="reg_input1" required>
												<label for="reg_input1">Username</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-floating">
												<input class="reg-box form-control" type="email" placeholder="Email" name="email_reg" id="reg_input2" required>
												<label for="reg_input2">Email</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-floating">
												<input class="reg-box form-control" type="password" placeholder="Password" name="pass_reg" id="reg_input3" required>
												<label for="reg_input3">Password</label>
											</div>
										</div>
										<div class="col-12">
											<div class="form-floating">
												<select class="reg-box form-select" name="type_reg" id="reg_input4" required>
													<option value="" disabled selected>Select an Account Type</option>
													<option value="1">User</option>
													<option value="2">Administrator</option>
												</select>
												<label for="reg_input4">Account Type</label>
											</div>
										</div>
									</div>
									<div class="mb-3">
										<input class="btn btn-danger rounded-pill w-50" type="submit" value="Register" name="reg_btn">
									</div>
									<div class="mb-3">
