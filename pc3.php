  ...
  <body>
    ...
    <section id="section1">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <img class="img" src="./resource/img/monitor.png" alt="">

            <div class="row prod-img">
              <h4 class="text-light pb-3">Related Products</h4>
              <div class="col">
                <a href="./pc7.php"><img src="./resource/img/monitor1.jpg" alt=""></a>
              </div>
              <div class="col">
                <a href="./pc5.php"><img src="./resource/img/monitor2.jpg" alt=""></a>
              </div>
              <div class="col">
                <a href="./pc6.php"><img src="./resource/img/system-unit1.png" alt=""></a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
