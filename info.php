...
<div class="container">
  <div class="wrapper mt-5">
    <div class="row">
      ...
      <div class="col-6 col-sm-8">
        <div class="item-desc">
          <h3>Gaming Keyboard And Mouse Combo Bundle Rainbow LED Game Equipment
            USB
            Wired PC Laptop T-WOLF TF200.</h3>
            ...
            <div class="buttons">
              <div class="button-left">
                <form class="mb-2" action="" method="">
                  <input class="btn btn-cart mr-5
                  btn-secondary mx-auto text-light" name="" style="font-size: .875rem;" type="submit"
                  value="Add to Cart">
                </form>
              </div>
              ...
              <div>
                <form class="mb-2" action="" method="">
                  <input class="btn btn-buy btn-danger mx-auto text-light" name=""
                  style="font-size: .875rem;" type="submit" value="Buy Now">
                </form>
              </div>
  ...
  <!-- Font Awesome -->
  <script src="https://kit.fontawesome.com/8460d5a0d5.js" crossorigin="anonymous"></script>
