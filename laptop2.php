...
<body>
    ...
    <section class="container main my-5 pt-5">
      <div class="row mt-5">
        <div class="col-lg-5 col-md-12 col-12">
          <img class="img-fluid w-100 pb-1" src="img/laptop2.png" alt="">
    ...
    <div class="col-lg-6 col-md-12 col-12">
     ...
     <p class="text-light">Experience unmatched portability and versatility with the KriziaWare Gigabyte XE4. Its lightweight design and long battery life make it ideal for travelers and professionals. Equipped with a convertible touchscreen, it effortlessly transforms from a laptop to a tablet, allowing you to work or play in various modes. The powerful AMD Ryzen processor and integrated graphics ensure seamless performance for all your tasks.</p>
     <span class="text-light">
       Processor: AMD Ryzen 9 5900HS<br>
       GPU: NVIDIA GeForce RTX 3060<br>
       RAM: 32GB DDR4<br>
       Storage: 1TB PCIe M.2 SSD<br>
       Display: 15.6-inch FHD (1920 x 1080) 300Hz<br>
     </span>
    </div>
  </div>
    </section>
